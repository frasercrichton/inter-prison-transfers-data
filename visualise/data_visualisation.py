...
prison_locations = 'data/prison-locations.json'
transfers = 'data/inter-prison-transfers-original.csv'
...
df.to_json('./data/inter-prison-transfers-original-formatted.json', orient='records')
...
# print(df['To'].value_counts())
df.to_json('./data/covid-inter-prison-transfers-original-formatted.json', orient='records')
